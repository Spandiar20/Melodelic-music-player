...
export default function MusicControl() {
  return (
    <div class="controls flex justify-between items-center w-full absolute bottom-0 bg-slate-500 h-24 px-8">
        <div className="queueIcon"> {/*This button is for setting queue this feature is not a priority currently*/}

        </div>

        <div className="mainControls flex flex-col">
